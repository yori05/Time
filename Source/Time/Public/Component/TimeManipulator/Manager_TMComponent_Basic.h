...
public:
	...
	FORCEINLINE bool IsInReplayState() { return TMState_Current == ETimeManipulatorState::TMS_Backward; };
	FORCEINLINE bool IsInHoldState() { return TMState_Current == ETimeManipulatorState::TMS_Hold; };
	FORCEINLINE bool IsInRecordState() { return TMState_Current == ETimeManipulatorState::TMS_Forward; };
